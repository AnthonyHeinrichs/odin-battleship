...
eval("var Player = function Player(id, ifAi) {\n  var aiHit = false;\n  var hitLeft = false;\n  var hitRight = false;\n  var hitBot = false;\n  var hitTop = false;\n  var firstHitNum = null;\n  var lastHitNum = null;\n  var nums = Array.from({\n    length: 100\n  }, function (_, i) {\n    return i + 1;\n  });\n  var isTurn = false;\n  var playerId = id;\n  var ai = ifAi;\n  return {\n    isTurn: isTurn,\n    playerId: playerId,\n    ai: ai,\n    setTurn: function setTurn() {\n      this.isTurn = !this.isTurn;\n    },\n    aiAttack: function aiAttack(gameboard, playerOne, playerTwo, showAttacks, checkWinner) {\n      if (aiHit == false) {\n        var ranNum = Math.floor(Math.random() * nums.length);\n        if (gameboard.receiveAttack(nums[ranNum]) == \"Ship hit\") {\n          aiHit = true;\n          checkWinner();\n        }\n        lastHitNum = nums[ranNum];\n        firstHitNum = nums[ranNum];\n        nums.splice(ranNum, 1);\n        showAttacks(playerTwo, gameboard);\n      } else if (aiHit == true) {\n        if (hitLeft == true) {\n          if (gameboard.board[lastHitNum - 2] !== undefined && !gameboard.board[lastHitNum - 2].hasBeenAttacked) {\n            if (gameboard.receiveAttack(lastHitNum - 1) == \"Ship hit\") {\n              lastHitNum = lastHitNum - 1;\n              nums = nums.filter(function (num) {\n                return num !== lastHitNum;\n              });\n              hitLeft = true;\n              showAttacks(playerTwo, gameboard);\n              checkWinner();\n            } else {\n              lastHitNum = lastHitNum - 1;\n              nums = nums.filter(function (num) {\n                return num !== lastHitNum - 1;\n              });\n              hitLeft = false;\n              showAttacks(playerTwo, gameboard);\n            }\n          } else {\n            hitLeft = false;\n            this.aiAttack(gameboard, playerOne, playerTwo, showAttacks, checkWinner);\n          }\n        } else if (hitRight == true) {\n          if (gameboard.board[lastHitNum] !== undefined && !gameboard.board[lastHitNum].hasBeenAttacked) {\n            if (gameboard.receiveAttack(lastHitNum + 1) == \"Ship hit\") {\n              lastHitNum = lastHitNum + 1;\n              nums = nums.filter(function (num) {\n                return num !== lastHitNum;\n              });\n              hitRight = true;\n              showAttacks(playerTwo, gameboard);\n              checkWinner();\n            } else {\n              lastHitNum = lastHitNum + 1;\n              nums = nums.filter(function (num) {\n                return num !== lastHitNum;\n              });\n              hitRight = false;\n              showAttacks(playerTwo, gameboard);\n            }\n          } else {\n            hitRight = false;\n            this.aiAttack(gameboard, playerOne, playerTwo, showAttacks, checkWinner);\n          }\n        } else if (hitTop == true) {\n          if (gameboard.board[lastHitNum - 11] !== undefined && !gameboard.board[lastHitNum - 11].hasBeenAttacked) {\n            if (gameboard.receiveAttack(lastHitNum - 10) == \"Ship hit\") {\n              lastHitNum = lastHitNum - 10;\n              nums = nums.filter(function (num) {\n                return num !== lastHitNum;\n              });\n              hitTop = true;\n              showAttacks(playerTwo, gameboard);\n              checkWinner();\n            } else {\n              lastHitNum = lastHitNum - 10;\n              nums = nums.filter(function (num) {\n                return num !== lastHitNum;\n              });\n              hitTop = false;\n              showAttacks(playerTwo, gameboard);\n            }\n          } else {\n            hitTop = false;\n            this.aiAttack(gameboard, playerOne, playerTwo, showAttacks, checkWinner);\n          }\n        } else if (hitBot == true) {\n          if (gameboard.board[lastHitNum + 9] !== undefined && !gameboard.board[lastHitNum + 9].hasBeenAttacked) {\n            if (gameboard.receiveAttack(lastHitNum + 10) == \"Ship hit\") {\n              lastHitNum = lastHitNum + 10;\n              nums = nums.filter(function (num) {\n                return num !== lastHitNum;\n              });\n              hitBot = true;\n              showAttacks(playerTwo, gameboard);\n              checkWinner();\n            } else {\n              lastHitNum = lastHitNum + 10;\n              nums = nums.filter(function (num) {\n                return num !== lastHitNum;\n              });\n              hitBot = false;\n              showAttacks(playerTwo, gameboard);\n            }\n          } else {\n            hitBot = false;\n            this.aiAttack(gameboard, playerOne, playerTwo, showAttacks, checkWinner);\n          }\n        } else {\n          if (gameboard.board[firstHitNum - 2] !== undefined && gameboard.board[firstHitNum - 2].hasBeenAttacked == false) {\n            if (gameboard.receiveAttack(firstHitNum - 1) == \"Ship hit\") {\n              lastHitNum = firstHitNum - 1;\n              nums = nums.filter(function (num) {\n                return num !== lastHitNum;\n              });\n              hitLeft = true;\n              showAttacks(playerTwo, gameboard);\n              checkWinner();\n            } else {\n              gameboard.receiveAttack(firstHitNum - 1);\n              lastHitNum = firstHitNum - 1;\n              nums = nums.filter(function (num) {\n                return num !== lastHitNum;\n              });\n              hitLeft = false;\n              showAttacks(playerTwo, gameboard);\n            }\n          } else if (gameboard.board[firstHitNum] !== undefined && gameboard.board[firstHitNum].hasBeenAttacked == false) {\n            if (gameboard.receiveAttack(firstHitNum + 1) == \"Ship hit\") {\n              lastHitNum = firstHitNum + 1;\n              nums = nums.filter(function (num) {\n                return num !== lastHitNum;\n              });\n              hitRight = true;\n              showAttacks(playerTwo, gameboard);\n              checkWinner();\n            } else {\n              gameboard.receiveAttack(firstHitNum + 1);\n              lastHitNum = firstHitNum + 1;\n              nums = nums.filter(function (num) {\n                return num !== lastHitNum;\n              });\n              hitRight = false;\n              showAttacks(playerTwo, gameboard);\n            }\n          } else if (gameboard.board[firstHitNum + 9] !== undefined && gameboard.board[firstHitNum + 9].hasBeenAttacked == false) {\n            if (gameboard.receiveAttack(firstHitNum + 10) == \"Ship hit\") {\n              lastHitNum = firstHitNum + 10;\n              nums = nums.filter(function (num) {\n                return num !== lastHitNum;\n              });\n              hitBot = true;\n              showAttacks(playerTwo, gameboard);\n              checkWinner();\n            } else {\n              gameboard.receiveAttack(firstHitNum + 10);\n              lastHitNum = firstHitNum + 10;\n              nums = nums.filter(function (num) {\n                return num !== lastHitNum;\n              });\n              hitBot = false;\n              showAttacks(playerTwo, gameboard);\n            }\n          } else if (gameboard.board[firstHitNum - 11] !== undefined && gameboard.board[firstHitNum - 11].hasBeenAttacked == false) {\n            if (gameboard.receiveAttack(firstHitNum - 10) == \"Ship hit\") {\n              lastHitNum = firstHitNum - 10;\n              nums = nums.filter(function (num) {\n                return num !== lastHitNum;\n              });\n              hitTop = true;\n              showAttacks(playerTwo, gameboard);\n              checkWinner();\n            } else {\n              gameboard.receiveAttack(firstHitNum - 10);\n              lastHitNum = firstHitNum - 10;\n              nums = nums.filter(function (num) {\n                return num !== lastHitNum;\n              });\n              hitTop = false;\n              showAttacks(playerTwo, gameboard);\n            }\n          } else {\n            var _ranNum = Math.floor(Math.random() * nums.length);\n            if (gameboard.receiveAttack(nums[_ranNum]) == \"Ship hit\") {\n              aiHit = true;\n              checkWinner();\n            }\n            firstHitNum = nums[_ranNum];\n            lastHitNum = nums[_ranNum];\n            nums.splice(_ranNum, 1);\n            aiHit = false;\n            showAttacks(playerTwo, gameboard);\n          }\n        }\n      }\n      playerOne.isTurn = true;\n      playerTwo.isTurn = false;\n    }\n  };\n};\nmodule.exports = Player;\n\n//# sourceURL=webpack://odin-battleship/./src/modules/player.js?");
